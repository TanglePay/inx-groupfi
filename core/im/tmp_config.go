...
var (
	NFT_ISSUER_LIST = []string{
		...
		"smr1zptqkwgav53969vcg8ktd6dq6cpkf6kf42e3emgncflugup4mfu97wpvvad",
	}
	...
	*/
	CONFIG_IN_TEXT = fmt.Sprintf(`[
		    {"groupName":"soon-whale","schemaVersion":1,"messageType":1,"authScheme":2, "qualifyType":"token", "chainName":"smr","collectionIds":[""],"tokenThres":"0.0001","tokenId":"0x0884298fe9b82504d26ddb873dbd234a344c120da3a4317d8063dbcf96d356aa9d0100000000"},
			{"groupName":"soon","schemaVersion":1,"messageType":1,"authScheme":2, "qualifyType":"token", "chainName":"smr","collectionIds":[""],"tokenThres":"0.00001","tokenId":"0x0884298fe9b82504d26ddb873dbd234a344c120da3a4317d8063dbcf96d356aa9d0100000000"},
			{"groupName":"smr-whale","schemaVersion":1,"messageType":1,"authScheme":2, "qualifyType":"token", "chainName":"smr","collectionIds":[""],"tokenThres":"0.00000636","tokenId":"%s"},
		    {"groupName":"smr","schemaVersion":1,"messageType":1,"authScheme":2, "qualifyType":"token", "chainName":"smr","collectionIds":[""],"tokenThres":"0.000000636","tokenId":"%s"},
			...
			{"groupName":"iceberg-9","schemaVersion":1,"messageType":1,"authScheme":2, "qualifyType":"nft", "chainName":"smr","collectionIds":["0x560b391d65225d159841ecb6e9a0d60364eac9aab31ced13c27fc47035da785f"]}]`, iotago.EncodeHex(im.SmrTokenId), iotago.EncodeHex(im.SmrTokenId))
